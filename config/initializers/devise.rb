...
Devise.setup do |config|
  ...
  # In the future, we will need up update the twitter key and secret once we create an app
  # This is where our twitter and facebook login key and secret will go
