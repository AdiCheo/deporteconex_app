...
(function($) {
    ...
    $.mbYTPlayer = {
        ...
        width: 450,
        controls: {
            play: "<img src='assets/YTPlayer/play.png'>",
            pause: "<img src='assets/YTPlayer/pause.png'>",
            mute: "<img src='assets/YTPlayer/mute.png'>",
            unmute: "<img src='assets/YTPlayer/unmute.png'>"
        },
        rasterImg: "assets/YTPlayer/raster.png",
            ...
            $.getScript("http://ajax.googleapis.com/ajax/libs/swfobject/2/swfobject.js", function() {
                players.each(function() {
                    ...
                    if ($.metadata) {
                        ...
                        if (player.metadata().muteSound) {
                            data.muteSound = player.metadata().muteSound;
                        }
                        if (player.metadata().loop) {
                            data.loop = player.metadata().loop;
                        }
                        if (player.metadata().hasControls) {
                            data.hasControls = player.metadata().hasControls;
                        }
                        if (player.metadata().ratio) {
                            data.ratio = player.metadata().ratio;
                        }
                        if (player.metadata().bufferImg) {
                            data.bufferImg = player.metadata().bufferImg;
                        }
                        if (player.metadata().ID) {
                            data.ID = player.metadata().ID;
                        }
                        if (player.metadata().autoplay != undefined) {
                            data.autoplay = player.metadata().autoplay;
                        }
                        if (player.metadata().showControls != undefined) {
                            data.showControls = player.metadata().showControls;
                        }
                        if (player.metadata().addRaster != undefined) {
                            data.addRaster = player.metadata().addRaster;
                        } else {
                            data.addRaster = false
                        }

                        if (player.metadata().lightCrop != undefined) {
                            data.lightCrop = player.metadata().lightCrop;
                        } else {
                            data.lightCrop = false
                        }
                    }
                    ...
                    if (data.isBgndMovie) {
                        ...
                        videoWrapper = $("<div/>").attr("id", "wrapper_" + ID).css({
                            overflow: "hidden",
                            position: pos,
                            left: 0,
                            top: 0,
                        ...
                        if (!data.width.toString().indexOf("%") == -1) {
                            var videoDiv = $("<div/>").css({
                                position: pos,
                                top: data.ratio == "4/3" && !data.ID ? -(data.height / 4) : 0,
                                left: 0,
                                display: "block",
                                width: data.width,
                                height: data.height
                        ...
                        videoWrapper = $("<span/>").attr("id", "wrapper_" + ID).css({
                            width: data.width,
                            height: data.height,
                            position: "relative",
                            opacity: 0
                        }).addClass("mb_YTVPlayer");
                        player.wrap(videoWrapper);
                    }
        ...
        setMovie: function() {
            ...
            var bufferImg = data.bufferImg ? $("<div/>").addClass("mbYTP_bufferImg").css({
                position: pos,
                top: 0,
                left: 0,
                width: "100%",
                height: "100%",
                background: "url(" + data.bufferImg + ")"
            }).hide() : false;
            var playerContainer = $(player).parents("div:first");
            var raster = $("<div/>").addClass("mbYTP_raster").css({
                opacity: 0,
                position: pos,
                top: 0,
                left: 0,
                width: "100%",
                height: "100%",
                background: "url(" + $.mbYTPlayer.rasterImg + ")"
            });
        ...
        buildYTPControls: function() {
            ...
            var controlBar = $("<span/>").addClass("mb_YTVPBar").css({
                whiteSpace: "noWrap",
                position: data.isBgndMovie && !data.ID ? "fixed" : "absolute"
            }).hide();
            ...
            var progressBar = $("<div/>").addClass("mb_YTVPProgress").css("position", "absolute").click(function(e) {
                ...
                YTPlayer.find(".mb_YTVPLoaded").css({
                    width: 0
                });
                var totalTime = Math.floor(player.getDuration());
